...
\title{Optical-Axis Anisotropy on the A=1 Discrete Causal Lattice:\\
       ...
       %% RELEASE: replace the next line with the reserved Zenodo DOI before the
       %% final v1.0 artifact is uploaded.
       DOI: to be assigned at the v1.0 Zenodo deposit.}}
