...
\title{Optical-Axis Birefringence on the A=1 Discrete Causal Lattice:\\
       Kinematic and Gauge-Sector Anisotropy along $(1,1,-1)$%
       \thanks{Version 0.1-DRAFT.  Paper~IV of the A=1 Discrete Causal
       Lattice series; takes up follow-on item~\#14
       (\emph{Balanced Equations and Birefringent Channels}) of
       Paper~I's \texttt{notes/follow\_on\_implications.md} catalogue.
       ...
       Pre-release draft; DOI to be assigned at v1.0 deposit.}}
...
\section{Kinematic Birefringence along $(1,1,-1)$}
\input{sections/kinematic_channel}

\section{Gauge-Sector Anisotropy along $(1,1,-1)$}
\input{sections/gauge_sector}
