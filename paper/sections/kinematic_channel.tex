...
% ── Scoping remark: vacuum birefringence and packet spreading are the ──
...
\begin{remark}[Vacuum birefringence and wave-packet spreading restate this channel]
...
observables and add no new claim. First, a polarization/direction-dependent
propagation speed---``vacuum birefringence''---is precisely the
ordinary/extraordinary split of Proposition~\ref{prop:speed_split} and
Eq.~\eqref{eq:H2_perp}; it is this section's subject, not a separate
prediction. Second, the anisotropic \emph{spreading} of an initially
